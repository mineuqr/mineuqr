 ...
 * For Saudi, customer-facing presentation uses CashierSaudiTaxInvoiceDialog.
 * This dialog remains the non-Saudi customer-facing paid receipt and an
 * operational artifact builder path (snapshot still retained for SA financially).
 */
