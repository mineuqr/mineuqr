...
export function ConnectorSessionCard({
  ...
  return (
    <div
      className={cn(
        "rounded-xl border bg-slate-900/30 px-4 py-3",
        tone === "warn" ? "border-amber-500/30" : "border-slate-800"
      )}
    >
      <div className="flex items-center gap-3">
        ...
        <span
          className={cn(
            ...
            tone === "ok" ? "text-emerald-400" : tone === "warn" ? "text-amber-300" : "text-slate-500"
          )}
        >
