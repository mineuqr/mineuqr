...
const COPY: Record<string, { ar: string; en: string }> = {
  ...
  viewSale: { ar: "عرض الفاتورة", en: "View sale" },
  ...
  sortPrice: { ar: "السعر", en: "Price" },
  favorites: { ar: "المفضلة", en: "Favorites" },
  available: { ar: "متاح", en: "Available" },
  addProduct: { ar: "إضافة", en: "Add" },
  paymentWorkspace: { ar: "الدفع", en: "Payment" },
  choosePaymentMethod: { ar: "اختر طريقة الدفع", en: "Choose payment method" },
  paidWorkspaceTitle: { ar: "تم الدفع", en: "Paid" },
  sendInvoice: { ar: "إرسال الفاتورة", en: "Send invoice" },
  incomingCount: { ar: "طلبات QR واردة", en: "Incoming QR Orders" },
  orderSourceQr: { ar: "طلب QR", en: "QR order" },
  orderSourceCashier: { ar: "كاشير", en: "Cashier" },
  orderSourceWaiter: { ar: "نادل", en: "Waiter" },
  orderSourceTable: { ar: "طاولة", en: "Table" },
  guests: { ar: "ضيوف", en: "Guests" },
  orderTime: { ar: "الوقت", en: "Time" },
