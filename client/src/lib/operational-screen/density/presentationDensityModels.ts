...
export const COMFORTABLE_DENSITY_MODEL: PresentationDensityModel = {
  ...
  lineItemClass: "text-[15px] font-semibold leading-snug text-foreground/90",
  quantityClass: "text-[17px] font-black tabular-nums leading-none text-foreground",
  notesClass: "text-sm font-medium leading-snug",
  notesPadding: "rounded-lg bg-muted/50 px-2.5 py-1.5",
  timingClass: "text-base font-extrabold tabular-nums tracking-tight text-foreground",
...
export const COMPACT_DENSITY_MODEL: PresentationDensityModel = {
  ...
  lineItemClass: "text-[13px] font-semibold leading-snug text-foreground/90",
  quantityClass: "text-[15px] font-black tabular-nums leading-none text-foreground",
  notesClass: "text-xs font-medium leading-snug",
  notesPadding: "rounded-md bg-muted/50 px-2 py-1",
  timingClass: "text-sm font-extrabold tabular-nums tracking-tight text-foreground",
