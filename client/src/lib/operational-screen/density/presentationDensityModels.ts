...
export const COMFORTABLE_DENSITY_MODEL: PresentationDensityModel = {
  ...
  orderNumberClass: "whitespace-nowrap font-mono text-2xl font-black tracking-tight leading-none",
  tableLabelClass: "text-xs font-medium text-muted-foreground/60",
  customerNameClass: "max-w-[45%] truncate text-sm font-medium text-muted-foreground",
  lineItemClass: "text-sm font-medium leading-snug text-foreground/80",
  notesClass: "text-sm font-medium leading-snug",
  notesPadding: "rounded-lg bg-muted/50 px-2.5 py-1.5",
  timingClass: "text-xl font-black tabular-nums tracking-tight text-foreground",
...
export const COMPACT_DENSITY_MODEL: PresentationDensityModel = {
  ...
  tableLabelClass: "text-[11px] font-medium text-muted-foreground/60",
  customerNameClass: "max-w-[45%] truncate text-xs font-medium text-muted-foreground",
  lineItemClass: "text-xs font-medium leading-snug text-foreground/80",
  notesClass: "text-xs font-medium leading-snug",
  notesPadding: "rounded-md bg-muted/50 px-2 py-1",
  timingClass: "text-lg font-black tabular-nums tracking-tight text-foreground",
