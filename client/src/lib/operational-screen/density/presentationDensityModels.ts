...
export const COMFORTABLE_DENSITY_MODEL: PresentationDensityModel = {
  ...
  tableLabelClass: "text-[11px] font-medium text-muted-foreground/70",
  ...
  quantityColumnClass: "w-[40px] min-w-[40px] max-w-[40px] shrink-0 text-end",
...
export const COMPACT_DENSITY_MODEL: PresentationDensityModel = {
  ...
  tableLabelClass: "text-[10px] font-medium text-muted-foreground/70",
