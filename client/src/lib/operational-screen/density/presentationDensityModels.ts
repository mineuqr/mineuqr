...
export const COMFORTABLE_DENSITY_MODEL: PresentationDensityModel = {
  ...
  lineItemClass: "text-sm font-semibold leading-snug text-foreground/90",
  quantityClass: "text-base font-black tabular-nums leading-none text-foreground",
  notesClass: "text-sm font-medium leading-snug",
  notesPadding: "rounded-lg bg-muted/50 px-2.5 py-1.5",
  timingClass: "text-lg font-extrabold tabular-nums tracking-tight text-foreground",
...
export const COMPACT_DENSITY_MODEL: PresentationDensityModel = {
  ...
  lineItemClass: "text-xs font-semibold leading-snug text-foreground/90",
  quantityClass: "text-sm font-black tabular-nums leading-none text-foreground",
