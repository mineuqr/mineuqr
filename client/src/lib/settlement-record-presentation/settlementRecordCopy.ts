...
export const settlementRecordUiLabels = {
  ...
  documentTypeSettlement: { ar: "تسوية", en: "Settlement" },
  documentTypeRefund: { ar: "مرتجع", en: "Refund" },
  refundNumber: { ar: "رقم المرتجع", en: "Refund Number" },
  originSettlementNumber: {
    ar: "التسوية الأصلية",
    en: "Origin Settlement",
  },
  refundReceiptTitle: { ar: "إيصال مرتجع", en: "Refund Receipt" },
  ...
  sourceChannelCounter: { ar: "الكاشير", en: "Counter" },
  sourceChannelTableOrder: { ar: "طلب طاولة", en: "Table Order" },
  sourceChannelWaiterOrder: { ar: "طلب ويتر", en: "Waiter Order" },
  sourceChannelSelfOrder: { ar: "طلب ذاتي", en: "Self-Order" },
  ...
  refundPreviouslyRefunded: {
    ar: "المرتجعات السابقة",
    en: "Previously Refunded",
  },
  refundFull: { ar: "استرداد كامل", en: "Full Refund" },
  refundPartial: { ar: "استرداد جزئي", en: "Partial Refund" },
  refundReasonRequired: { ar: "السبب (مطلوب)", en: "Reason (required)" },
  refundManagerApproval: {
    ar: "موافقة المدير",
    en: "Manager approval",
  },
  refundSave: { ar: "حفظ", en: "Save" },
  refundSaveAndPrint: { ar: "حفظ وطباعة", en: "Save & Print" },
  refundWindowExpiredTitle: {
    ar: "انتهت فترة الاسترداد.",
    en: "Refund period has expired.",
  },
  refundWindowAllowed: { ar: "النافذة المسموحة", en: "Allowed Window" },
  refundWindowHours: { ar: "ساعة", en: "hours" },
  refundWindowElapsed: { ar: "الوقت المنقضي", en: "Elapsed Time" },
  refundErrorUnknownSettlement: {
