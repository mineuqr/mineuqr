 ...
 * Never aggressive; motion-safe gated.
 */
export const SEMANTIC_HOVER_PREMIUM = cn(
  SEMANTIC_MOTION_PREMIUM,
  "motion-safe:hover:-translate-y-0.5",
  "hover:border-cyan-400/45",
  "hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_0_0_1px_rgba(34,211,238,0.10),0_10px_28px_-8px_rgba(6,182,212,0.28),0_4px_12px_-4px_rgba(2,6,23,0.55)]",
  "motion-safe:hover:brightness-[1.035]"
);
...
export const SEMANTIC_SELECTED =
  "data-[selected=true]:border-cyan-400/55 data-[selected=true]:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_0_0_1px_rgba(34,211,238,0.18),0_8px_24px_-6px_rgba(6,182,212,0.25)]";
...
/** Icon micro-reaction inside group cards. */
export const SEMANTIC_ICON_HOVER = cn(
  SEMANTIC_MOTION_PREMIUM,
  "motion-safe:group-hover:scale-110 motion-safe:group-hover:drop-shadow-[0_0_8px_rgba(34,211,238,0.45)]"
);
...
export const SEMANTIC_ICON_WELL_HOVER = cn(
  ...
  "group-hover:border-cyan-400/35 group-hover:bg-cyan-500/10",
  "motion-safe:group-hover:shadow-[0_0_16px_-4px_rgba(34,211,238,0.35)]"
);

/** KPI value emphasis — subtle live feel on hover (primary / revenue). */
export const SEMANTIC_VALUE_HOVER =
  "motion-safe:transition-[filter,opacity] motion-safe:duration-300 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)] motion-safe:group-hover:brightness-110";
