 ...
 *
 * Customer journey ends at Place Order → Confirmation.
 * No customer settlement / payment selection.
 * Settlement Platform remains server-side for cashier adoption (Phase 4+).
 */
...
export function KioskCheckoutStage({
  ...
  const handlePlaceOrder = async () => {
    ...
    // Place → clear cart + confirmation (OrderingCheckoutProvider default path).
    // Customer never settles; do not defer post-place navigation.
