...
| Orders | OrderSalesRollup (sum) | 103 | Executive (operational), Financial, Order Sales |
...
| Orders | OrderSalesRollup (sum) | 2688 | Executive (operational), Financial, Order Sales |
| Tax / Complimentary / Voided | BusinessMetricsSummary | (analysis) | Financial Summary only — Tax = full period paid checks |
