...
**Current canonical lineage:** `0000_shiny_blizzard` → `0086_commercial_live_plans` (87 journal entries).
...
| Fact | Status |
|------|--------|
| Journal defines order `0000` → `0086` | **Canonical** — terminus `0086_commercial_live_plans` (87 entries) |
