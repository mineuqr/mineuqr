...
| ADR-ARCH-037 | Payment Process Domain | **Accepted** (governance) | Architecture Authority | PAYMENT-CONSTITUTIONAL-REFINEMENT-1 · PAYMENT-CONFIRM-SERVICE-1 · PAYMENT-CONFIRM-REMAINING-CALLERS-1 | — | FSP Payment process vs Check aggregate | **Partial (Confirm façade + caller convergence)** | Refines 020/023/024/026/032. Payment = process owner; Check = sole monetary aggregate. One formula `computeCheckMoney`. Collection stays ST. No payments table. I-PAY-01…18. Confirm Payment callers enter `confirmPayment` → `settleCheckPaidByIdDetailed` (I-PAY-14 host). Formula extraction and CheckService reduction remain deferred. |
