...
| ADR-ARCH-028 | Cash Register Management Platform (CRMP) | **Accepted** | Architecture Authority | CASH-REGISTER-MANAGEMENT-ARCHITECTURE-1 · CRMP-DOMAIN-DESIGN-1 · CRMP-IMPLEMENTATION-1 · REGISTER-OPERATIONS-IMPLEMENTATION-1 · CRMP-PRODUCTION-MIGRATION-0079 · CRMP-OPERATIONS-API-1 | — | Register / Financial Shift / Drawer accountability / Settlement Attribution | **Partial (domain + Duty + API)** | Domain + production terminus `0079`; Register Duty + Operations API (`crmp.register.*`) certified. No UI / Reporting yet. Check remains sole monetary AR (020); SR Check-published (026); no Cashier domain. |
