...
| ADR-ARCH-019 | Order Identity via Service Mode and Fulfilment Anchor | **Proposed** | Architecture Authority | KIOSK-ORDER-IDENTITY-ARCHITECTURE-1 | — | Order identity / PlaceOrder / Session | Not implemented | Generalizes table-only identity for kiosk/counter/pickup/drive-thru; refines TableReference exclusivity |
