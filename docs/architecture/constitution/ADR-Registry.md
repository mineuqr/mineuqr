...
| ADR-ARCH-031 | Data Retention & Archival Platform (DRAP) | **Accepted** (governance) | Architecture Authority | DATA-RETENTION-ARCHITECTURE-1 · DATA-RETENTION-PLATFORM-1 | — | Cross-cutting Display Window · Operational Retention · Cold Archive · Restore · Purge | **Partial (platform lib)** | `shared/data-retention` foundation certified. No domain adoption / DB / API yet. Settlement Records Permanent. Archive ≠ second SSOT. Does not modify 020/022/026/028/030 ownership. |
