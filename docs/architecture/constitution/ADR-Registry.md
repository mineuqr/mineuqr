...
| ADR-ARCH-028 | Cash Register Management Platform (CRMP) | **Accepted** | Architecture Authority | CASH-REGISTER-MANAGEMENT-ARCHITECTURE-1 · CRMP-DOMAIN-DESIGN-1 · CRMP-IMPLEMENTATION-1 · REGISTER-OPERATIONS-IMPLEMENTATION-1 · CRMP-PRODUCTION-MIGRATION-0079 | — | Register / Financial Shift / Drawer accountability / Settlement Attribution | **Partial (domain + Duty)** | Domain + production terminus `0079_crmp_register_duty`; Register Duty + Shift lifecycle + Settlement Context/Attribution adoption certified. No UI / Operations API / Reporting yet. Check remains sole monetary AR (020); SR Check-published (026); no Cashier domain. |
