...
| ADR-ARCH-031 | Data Retention & Archival Platform (DRAP) | **Accepted** (governance) | Architecture Authority | DATA-RETENTION-ARCHITECTURE-1 | — | Cross-cutting Display Window · Operational Retention · Cold Archive · Restore · Purge | **Not implemented** | Single retention authority; domains must not invent retention. Financial Shift first adopter (future). Settlement Records Permanent (Never purge by default). Archive ≠ second SSOT. Does not modify 020/022/026/028/030 ownership. |
