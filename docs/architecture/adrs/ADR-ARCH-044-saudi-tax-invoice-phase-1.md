...
- Simplified Tax Invoice: mandatory Phase 1 QR (TLV tags 1–5 per official QRCodeCreation.pdf).
- Tax Invoice: title + buyer VAT when Standard + business tax number; QR not enabled.
