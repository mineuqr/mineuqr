...
export const KPI_DICTIONARY = Object.freeze({
  revenue: def({
    ...
    formula:
      "SUM(settlement_records.grandTotal WHERE outcome = 'paid' AND recordGeneration = 1) /* Settlement Record publication of paid Check.grandTotal */",
    kpiClass: "business",
    ownerDomain: "check",
    ...
    dtoField: "revenue",
    sourceOfTruth:
      "settlement_records where outcome = paid → SUM(grandTotal) (Check freeze publication)",
    unit: "money",
